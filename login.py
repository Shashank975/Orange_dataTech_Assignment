...
class Login:
    def __init__(self,root):
        ...
        get_str = Label(frame1,text="Admin Login",font=("times new roman",20,"bold"),fg="white",bg="#002B53")
        ...
        loginbtn=Button(frame1,command=self.login,text="Admin Login",font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="#002B53",bg="white",activeforeground="white",activebackground="#007ACC")
    ...
    def login(self):
        if (self.txtuser.get()=="" or self.txtpwd.get()==""):
            ...
            mycursor.execute("select * from login where email=%s and pwd=%s",(
                self.txtuser.get(),
                self.txtpwd.get()
            ))
...
# This part is image labels setting start 
        ...
        # Photo   button 6
        pho_img_btn=Image.open(r"D:\College Project\Face-Recognition-Attendence-System\Images_GUI\qr1.png")
